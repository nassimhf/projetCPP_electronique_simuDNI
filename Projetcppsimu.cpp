...
// Projetcppsimu.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CProjetcppsimuApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construction de CProjetcppsimuApp

CProjetcppsimuApp::CProjetcppsimuApp()
{
...
// Le seul et unique objet CProjetcppsimuApp

CProjetcppsimuApp theApp;


// Initialisation de CProjetcppsimuApp

BOOL CProjetcppsimuApp::InitInstance()
{
